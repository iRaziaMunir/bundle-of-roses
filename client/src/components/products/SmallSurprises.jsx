...
const SECTION_ID = HOME_COLLECTION_SECTION_IDS.SMALL_SURPRISES;

export default function SmallSurprises() {
  ...
  return (
    <section className="pt-16 max-w-8xl mx-auto">
      <h2 className="text-center text-3xl tracking-widest font-light mb-12 uppercase">Small Surprises</h2>
