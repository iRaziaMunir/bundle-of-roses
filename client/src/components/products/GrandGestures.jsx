...
const SECTION_ID = HOME_COLLECTION_SECTION_IDS.GRAND_GESTURES;

export default function GrandGestures() {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      ...
      <h2 className="text-center text-3xl tracking-widest font-light mb-12 uppercase">Grand Gestures</h2>
